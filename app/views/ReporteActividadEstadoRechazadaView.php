...
class ReporteActividadEstadoRechazadaView {
    ...
    public function showAll($Reporte) {
        ...
        ?>
        <script>
        parent.Windows.getFocusedWindow().setTitle('Reportes :: Actividades Rechazadas');

        function updateReport() {
            new Ajax.Updater('div-list', '<?php echo WEB_PATH; ?>/ReporteActividadEstadoRechazada/updateList', {
