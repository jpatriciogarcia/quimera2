...
class ReporteUsuariosTotalesView {
    ...
    public function showAll($Reporte) {
        ...
        ?>
        <script>
        parent.Windows.getFocusedWindow().setTitle('Reportes :: Usuarios Totales');

        function updateReport() {
            new Ajax.Updater('div-list', '<?php echo WEB_PATH; ?>/ReporteUsuariosTotales/updateList', {
                parameters: { centro_familiar: $('centro_familiar').value },
