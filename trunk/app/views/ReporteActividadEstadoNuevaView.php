...
class ReporteActividadEstadoNuevaView {
    ...
    public function showAll($Reporte) {
        ...
        ?>
        <script>
        parent.Windows.getFocusedWindow().setTitle('Reportes :: Actividades Nuevas');

        function updateReport() {
            new Ajax.Updater('div-list', '<?php echo WEB_PATH; ?>/ReporteActividadEstadoNueva/updateList', {
