...
class ReporteActividadEstadoObservadaController extends ReporteActividadEstadoObservadaModel {
    ...
    public function index() {
        ReporteActividadEstadoObservadaView::showAll($this->Find('1=?', array('1')));
    }
    ...
    public function updateList() {
        ...
        echo ReporteActividadEstadoObservadaView::getList( $this->Find($sql) );
