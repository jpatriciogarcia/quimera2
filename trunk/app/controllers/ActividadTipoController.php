<?php
/**
 * Objeto ActividadTipoController.
 *
...
class ActividadTipoController extends ActividadTipoModel {
    ...
    public function index() {
        ActividadTipoView::showAll($this->Find('1=?', array('1')));
    }
    ...
    public function liveSearch( $value ) {
        ...
        ActividadTipoView::liveSearch($this->Find($whereOrderBy));
    }
