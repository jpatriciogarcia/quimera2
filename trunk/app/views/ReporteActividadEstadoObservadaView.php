...
class ReporteActividadEstadoObservadaView {
    ...
    public function showAll($Reporte) {
        ...
        ?>
        <script>
        parent.Windows.getFocusedWindow().setTitle('Reportes :: Actividades Observadas');

        function updateReport() {
            new Ajax.Updater('div-list', '<?php echo WEB_PATH; ?>/ReporteActividadEstadoObservada/updateList', {
