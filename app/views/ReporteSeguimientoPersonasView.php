...
class ReporteSeguimientoPersonasView {
    ...
    public function showAll($Reporte) {
	    ...
	    <table width="100%">
	      ...
	      <tr>
	        ...
	        <td>&nbsp;</td>
	        <td><?php echo HtmlHelper::imageButton('buscar_SeguimientoPersonas', "onclick='updateReport()'") ?></td>
	        </tr>
        ...
        function updateReport() {
            new Ajax.Updater('div-list', '<?php echo WEB_PATH; ?>/ReporteSeguimientoPersonas/updateList', {
