...
class ReportePersonaPorActividadView {
    ...
    public function showAll($Reporte) {
	    ...
	    <table width="100%">
	      ...
	      <tr>
	        ...
	        <td><?php echo FormHelper::inputText('actividad', '', false, array('class' => 'required validate-max-13 textinput' )); ?></td>
	        <td><?php echo FormHelper::inputText('nombreactividad', '', false, array('class' => 'required validate-max-30 textinput' )); ?></td>
	        <td>&nbsp;</td>
	        <td><?php echo HtmlHelper::imageButton('buscar_PersonaPorActividad', "onclick='updateReport()'") ?></td>
	        </tr>
        ...
        ?>
        <script>
        parent.Windows.getFocusedWindow().setTitle('Reportes :: Personas por Actividad');

        function updateReport() {
            new Ajax.Updater('div-list', '<?php echo WEB_PATH; ?>/ReportePersonaPorActividad/updateList', {
                parameters: { actividad: $('actividad').value, nombreactividad: $('nombreactividad').value },
    ...
    public function getList($Reporte) {
        ...
        foreach ($Reporte as $Reporte) {
            ...
            ."\n  <td><div align='left'>{$Reporte->actividad}</div></td>"
