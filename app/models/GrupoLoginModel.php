<?php
/**
 * Objeto GrupoLoginModuloModel.
 *
 * En este archivo se define la clase para crear al patr�n Active Record para la
...
class GrupoLoginModel extends ADOdb_Active_Record {

	public $_table = 'grupo_login';
	private $_pkeys = array('codigo_grupo', 'usuario');
