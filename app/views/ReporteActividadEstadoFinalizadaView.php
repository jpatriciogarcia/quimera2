...
class ReporteActividadEstadoFinalizadaView {
    ...
    public function showAll($Reporte) {
        ...
        ?>
        <script>
        parent.Windows.getFocusedWindow().setTitle('Reportes :: Actividades Finalizadas');

        function updateReport() {
            new Ajax.Updater('div-list', '<?php echo WEB_PATH; ?>/ReporteActividadEstadoFinalizada/updateList', {
