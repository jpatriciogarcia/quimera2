...
class ReporteActividadEstadoFinalizadaController extends ReporteActividadEstadoFinalizadaModel {
    ...
    public function index() {
        ReporteActividadEstadoFinalizadaView::showAll($this->Find('1=?', array('1')));
    }
    ...
    public function updateList() {
        ...
        echo ReporteActividadEstadoFinalizadaView::getList( $this->Find($sql) );
