...
class ReporteActividadExitosaController extends ReporteActividadExitosaModel {
    ...
    public function index() {
        ReporteActividadExitosaView::showAll($this->Find('1=?', array('1')));
    }
    ...
    public function updateList() {
        ...
        if (isset($_POST['centro_familiar']) ? $_POST['centro_familiar'] : false) {
            $sql = 'centro_familiar_codigo = ' . $_POST['centro_familiar'];
        }
        ...
        echo ReporteActividadExitosaView::getList( $this->Find($sql) );
    }
