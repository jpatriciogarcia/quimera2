...
class ReporteDatosMonitoresView {
    ...
    public function showAll($Reporte) {
	    ...
	    <table width="100%">
	      ...
	      <td><?php echo HtmlHelper::imageButton('buscar_datos_monitor', "onclick='updateReport()'") ?></td>
	        </tr>
        ...
        ?>
        <script>
        parent.Windows.getFocusedWindow().setTitle('Reportes :: Datos Monitores');

        function updateReport() {
            new Ajax.Updater('div-list', '<?php echo WEB_PATH; ?>/ReporteDatosMonitores/updateList', {
