...
class ReporteTotalNacionalActividadesNuevasController extends ReporteTotalNacionalActividadesNuevasModel {
    ...
    public function index() {
        ReporteTotalNacionalActividadesNuevasView::showAll($this->Find('1=?', array('1')));
    }
    ...
    public function updateList() {
        ...
        echo ReporteTotalNacionalActividadesNuevasView::getList( $this->Find($sql) );
    }
