...
class ReporteActividadEstadoAprobadaController extends ReporteActividadEstadoAprobadaModel {
    ...
    public function index() {
        ReporteActividadEstadoAprobadaView::showAll($this->Find('1=?', array('1')));
    }
    ...
    public function updateList() {
        ...
        echo ReporteActividadEstadoAprobadaView::getList( $this->Find($sql) );
