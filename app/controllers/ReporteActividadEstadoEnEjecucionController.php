...
class ReporteActividadEstadoEnEjecucionController extends ReporteActividadEstadoEnEjecucionModel {
    ...
    public function index() {
        ReporteActividadEstadoEnEjecucionView::showAll($this->Find('1=?', array('1')));
    }
    ...
    public function updateList() {
        ...
        echo ReporteActividadEstadoEnEjecucionView::getList( $this->Find($sql) );
