...
class ReporteDatosMonitoresController extends ReporteDatosMonitoresModel {
	...
	public function index() {
		ReporteDatosMonitoresView::showAll($this->Find('1=?', array('1')));
	}
	...
	public function updateList() {
		...
		echo ReporteDatosMonitoresView::getList( $this->Find($sql) );
	}
